...
//                mCandidatesAreaHeight = (int) (mScreenHeight * CANDIDATES_AREA_HEIGHT_RATIO_PORTRAIT);
                //0.68571428
                mKeyHeight = (int) (mScreenHeight * 0.072);
                mCandidatesAreaHeight = (int) (mScreenHeight * 0.0576);
                scale = mScreenWidth;
            } else {
